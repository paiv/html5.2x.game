...
this.cache.bind(this,m))};c.prototype.cache=function(m,c){this.j[m]=c};c.prototype.G=function(c){if(c){var q=this.context.createBufferSource();q.buffer=c;q.connect(this.context.destination);q.start()}};c.prototype.ga=function(){this.G(this.j["sfx/pickup_coin.wav"])};c.prototype.ja=function(){this.G(this.j["sfx/win.wav"])};c.prototype.fa=function(){this.G(this.j["sfx/loose.wav"])};c.prototype.T=function(c){var q=this.j["sfx/drill.wav"];if(q&&!this.D){var y=this.context.createBufferSource(),z=this.context.createGain();
